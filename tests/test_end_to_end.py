...
def test_encode_decode_bitfields(odyssey):
    ...
    with NamedTemporaryFile() as fencode:
        ...
        for frame in reader.frames:
            ...
            assert col14.bitfields[0].size == 1
            assert col14.bitfields[0].offset == 0
            assert col14.bitfields[1].name == "bfextended"
            assert col14.bitfields[1].size == 2
            assert col14.bitfields[1].offset == 1
            assert col14.bitfields[2].name == "bf3"
            assert col14.bitfields[2].size == 1
            assert col14.bitfields[2].offset == 3
